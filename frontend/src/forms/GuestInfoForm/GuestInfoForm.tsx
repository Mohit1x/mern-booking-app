        ...
        <div className="grid grid-cols-1 gap-4 items-center">
          <div>
            <DatePicker
              ...
              className="min-w-full bg-white placeholder:text-lg p-2 focus:outline-none"
          ...
          <div className="flex bg-white px-2 py-1 gap-2">
            ...
            <label className="items-center flex">
              ...
              <input
                ...
                min={0}
                max={20}
                {...register("chlildCount", {
                  valueAsNumber: true,
                })}
              />
            </label>
            {errors.adultsCount && (
              <span className="text-red-500 text-semi-bold text-sm">
